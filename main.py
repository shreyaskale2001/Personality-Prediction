...
# ---------------- UTILITY TO CONVERT NUMPY TYPES ----------------
...
questions = [
    ...
    "My emotions fluctuate frequently throughout the day",
    "I notice rapid changes in how I feel emotionally",
    "I get annoyed easily",
    "I often feel sad",
    "I rarely involve myself in others’ issues",
    "I like learning about other people",
    "I sometimes say rude things to others",
    "I understand how others feel",
    "I sometimes ignore what others are going through",
    "I am kind and caring toward others",
    "I don't pay much attention to others",
    "I like helping other people",
    "I can sense others’ emotions without them telling me",
    ...
    "I occasionally include sophisticated vocabulary in conversation",
...
# ---------------- DESCRIPTIONS ----------------
descriptions = {
    "Openness": {"desc": "You enjoy new experiences and are curious about the world. You appreciate art, adventure, and different ideas. You have a strong imagination and can quickly understand new concepts.","roles": "Product Designer, Researcher, Innovation Manager, Strategy Analyst"},
    "Conscientiousness": {"desc": "You are disciplined and organized. You like planning things in advance, paying attention to details, and following schedules. You prefer structured and well-organized work.","roles": "Project Manager, Operations Manager, Financial Analyst, Engineer"},
    "Extraversion": {"desc": "You enjoy being around people and often take the lead in social situations. You are energetic, talkative, and comfortable being the center of attention.","roles": "Sales Manager, Marketing Executive, HR Manager, Public Relations Specialist"},
    "Agreeableness": {"desc": "You value harmony and good relationships with others. You are kind, helpful, and considerate of people’s feelings, which makes others feel comfortable around you.","roles": "Human Resources Specialist, Counselor, Customer Success Manager, Teacher"},
    "Neuroticism": {"desc": "You may experience emotions strongly and sometimes feel stressed or worried. You can be sensitive to pressure and may prefer calm environments.","roles": "Quality Assurance Analyst, Risk Analyst, Research Assistant, Data Analyst"}
}

# ---------------- SUBMIT ----------------
if st.button("Submit Assessment", key="submit_button"):
    if not name or not job_role or not company:
        ...
        ml_trait_scores = {
            trait_mapping[cls] if cls in trait_mapping else str(cls): round(prob * 100, 2)
